...
# 在特定年份绘制标注线和文字
plt.axvline(x=1995, color='r', linestyle='--')
plt.text(1995.5, 1, 'Lang Ping Joined CHN Volleyball', fontsize=12, color='r')

plt.axvline(x=1998, color='r', linestyle='--')
plt.text(1998.5, 2, 'Lang Ping Left CHN Volleyball', fontsize=12, color='r')

plt.axvline(x=2013, color='r', linestyle='--')
plt.text(2013.5, 1, 'Lang Ping Joined CHN Volleyball', fontsize=12, color='r')
